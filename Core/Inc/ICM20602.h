...
#define ICM20602_SPI_CS_CLK			LL_AHB1_GRP1_PERIPH_GPIOA

#define ICM20602_INT_PIN			LL_GPIO_PIN_1
#define ICM20602_INT_PORT			GPIOA
...
#define	XG_OFFS_TC_H	0x04 //not included in 20608
#define	XG_OFFS_TC_L	0x05//not included in 20608
...
typedef struct _ICM20602{
	...
	//degree with accel value only
	float acc_total_vect;
	float angle_pitch_acc;
	float angle_roll_acc;

	//final angle with complementary filter
	float angle_roll;
	float angle_pitch;
	float angle_yaw;
