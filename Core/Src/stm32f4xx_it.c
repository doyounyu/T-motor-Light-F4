...
uint8_t sumd_rx_buf[37];		// sumd buffer
uint8_t sumd_rx_cplt_flag = 0; // sumd read complete flag

uint8_t uart2_rx_flag = 0;
uint8_t uart2_rx_data = 0;

//bluetooth/UART related variables
uint8_t uart1_rx_flag = 0;
uint8_t uart1_rx_data = 0;

//Control Loop Timer Related variables
uint8_t tim2_1ms_flag = 0;
