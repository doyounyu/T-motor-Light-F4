...
double gyro_x_offset = -2.27;
double gyro_y_offset = 2.10;
double gyro_z_offset = 0.121;
...
double p_gain_roll = 1.0F; double p_gain_pitch = 1.0F;
double i_gain_roll = 0.0F; double i_gain_pitch = 0.0F;
double d_gain_roll = 0.0F; double d_gain_pitch = 0.0F;
	  ...
	  if(uart1_rx_flag == 1)
		  {
			  ...
			  printf("P: %.3lf\tI: %.3lf\tD: %.3lf\r", p_gain_roll, i_gain_roll, d_gain_roll);
